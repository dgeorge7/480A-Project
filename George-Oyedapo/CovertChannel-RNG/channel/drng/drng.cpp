...
void setup(int argc, char**argv)
{
    auto usage = [&]() {
        ...
        cout << "   verbose     -- set verbose to report more info                      -- 0/1              -- default: 0 " << endl;
